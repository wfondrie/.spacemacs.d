...
you should place your code here."
  ...
  ;; jupyter server ip address
  (setq-default ein:jupyter-server-args
                (list "--no-browser" "--ip=0.0.0.0"))
